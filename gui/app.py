    ...
    def update_metrics(self):
        ...
        if not got_real_data and len(self.metrics_history) > 0:
            if duration > 3.0:
                ...
                # Calculate calories using MET method from documentation
                ...
                # Using default weight of 70kg if not specified
                weight_kg = 70 # this is mine
                
                # Determine MET based on current speed
                ...
                # Calculate calories burned in this time interval
